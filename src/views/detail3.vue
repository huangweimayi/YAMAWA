...
<script>
  ...
  export default {
    ...
    data(){
      return{
        ...
        up:[
          ...
          {name:"刃部距",value:'',code:'blade_distance'},
          {name:"牙距/牙数",value:'',code:'pitch'},
          {name:"全长",value:'',code:'length'},
          {name:"螺纹长",value:'',code:'thread_length'},
          {name:"柄径",value:'',code:'handle_diameter'},
          {name:"刃数",value:'',code:'teeth_num'},
          {name:"沟形",value:'',code:'ditch_shape'},
          {name:"最小加工径(mm)",value:'',code:'min_processing_diameter'},
          {name:"最大加工径(mm)",value:'',code:'max_processing_diameter'},
    ...
    methods:{
      getDetail(){
        let _t = this;
        api.chongdaoDetail({id:_t.id}).then(res => {
