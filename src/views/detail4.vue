...
<script>
  ...
  export default {
    ...
    data(){
      return{
        ...
        up:[
          ...
          {name:"构型种类",value:'',code:'configuration_type'},
          ...
          {name:"砖头长",value:'',code:'brick_length'},
          {name:"柄径",value:'',code:'handle_diameter'},
          {name:"Rmax",value:'',code:'rmax'},
          {name:"Rmin",value:'',code:'rmin'},
          {name:"D1",value:'',code:'d1'},
          {name:"D2",value:'',code:'d2'},
    ...
    methods:{
      getDetail(){
        let _t = this;
        api.zhuanDetail({id:_t.id}).then(res => {
